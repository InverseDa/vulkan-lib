...
//void Shader::SetDescriptorSetLayoutBinding(const std::string& setName, const std::string& descriptorName, vk::DescriptorType type, vk::ShaderStageFlags stage, int binding, int count) {
//    vk::DescriptorSetLayoutBinding layoutBinding;
//    layoutBinding.setBinding(binding)
//        .setDescriptorCount(count)
//        .setDescriptorType(type)
//        .setStageFlags(stage);
//    ShaderMgr::GetInstance().SetDescriptorSetLayoutBinding(setName, descriptorName, layoutBinding);
//}
